...
<head>
    ...
    <title>Feedback - Attendify</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="css/style.css" rel="stylesheet">
    <link href="css/feedback.css" rel="stylesheet"> <!-- Link to the new CSS file -->
...
<body class="bg-light">
    ...
    <main class="container mt-5">
        ...
        <form id="feedbackForm">
            <div class="mb-3">
                ...
                <textarea class="form-control" id="feedbackMessage" rows="4" placeholder="Write your feedback here..."></textarea>
            </div>
    ...
    <script src="js/feedback.js"></script> <!-- Link to the new JavaScript file -->
</body>
</html>