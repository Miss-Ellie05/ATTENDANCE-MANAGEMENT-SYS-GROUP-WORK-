...
<head>
    ...
    <link href="css/schedule.css" rel="stylesheet"> <!-- Link to the new CSS file -->
...
<body class="bg-light">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="schedule.jsp">Schedule</a>
                    </li>
                    <li class="nav-item">
    ...
    <script src="js/schedule.js"></script> <!-- Link to the new JavaScript file -->
</body>
</html>