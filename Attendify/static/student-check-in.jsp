...
<head>
    ...
    <title>Student Check-in - Attendify</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="css/style.css" rel="stylesheet">
    <link href="css/student-check-in.css" rel="stylesheet"> <!-- Link to the new CSS file -->
...
<body class="bg-light">
    ...
    <main class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h2 class="text-center mb-4">Student Check-in</h2>
                        <div id="location-status" class="mt-3 text-center text-muted">
                            <i class="fas fa-map-marker-alt me-2"></i>
                            <span id="location-text">Checking location...</span>
                        </div>
                        <h4 class="mt-4">Voice Check-in</h4>
                        <p>Please say the following phrase to check in:</p>
    ...
    <script src="js/student-check-in.js"></script> <!-- Link to the new JavaScript file -->
</body>
</html>