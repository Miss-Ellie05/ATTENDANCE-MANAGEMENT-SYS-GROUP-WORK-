...
<head>
    ...
    <link href="css/assignments.css" rel="stylesheet"> <!-- Link to the new CSS file -->
...
<body class="bg-light">
    ...
    <main class="container mt-5">
        ...
        <table class="table table-striped">
            ...
            <tbody id="assignmentsBody">
                <!-- Assignments data will be populated here dynamically -->
            </tbody>
        </table>
    </main>
    ...
    <script src="js/assignments.js"></script> <!-- Link to the new JavaScript file -->
</body>
</html>